...
explore: vw_medical {
  ...
  sql_always_where: ${Paid_year} IN ('2020', '2021','2022') ;;
}

explore: vw_pharmacy {
  label: "Pharmacy records"
  sql_always_where: ${date_filled_year} IN ('2020', '2021','2022') ;;
}
...
explore: ad_hoc_query_tool_medical {
  ...
  sql_always_where: ${PAID_DATE_year} IN ('2020', '2021','2022') ;;
}

explore: ad_hoc_query_tool_pharmacy {
  label: "Ad Hoc Query Tool_PHARMACY"
  sql_always_where: ${SERVICE_DATE_year} IN ('2020', '2021'.'2022') ;;
}
...
explore: vw_risk_group_migration {
  ...
  sql_always_where: ${File_year} IN ('2020', '2021','2022') ;;
}
